<?php /*a:2:{s:69:"D:\phpstudy_pro\WWW\tpmood\application\admin\view\index\cadusers.html";i:1583419168;s:66:"D:\phpstudy_pro\WWW\tpmood\application\admin\view\public\base.html";i:1583474682;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    $(function(){
        $('#save').click(function () {
            ...
            $.ajax({
                url:"<?php echo url('admin/index/cadusers',['uid'=>$user['id']]); ?>",
                type:'post',
        ...
        $('#del').click(function () {
            layer.confirm('您确定要删除吗?',{btn: ['确定', '取消'],title:"提示"}, function(){
                $.ajax({
                    type: "post",
                    url: "<?php echo url('admin/index/dadusers',['uid'=>$user['id']]); ?>",
                    dataType: "json",
                    success:function(data) {
                        if(data.code == 1){
                            layer.msg(data.msg,{
        ...
        <div class="set">
            ...
            <div style="padding: 50px">
                ...
                <div style="color: #fff;position: relative">
                    ...
                    <input type="text" value="<?php echo htmlentities($user['password']); ?>" id="password" >
                </div>
                <hr>
                <div style="color: #fff;position: relative">
                    <span>Is_super：</span>
                    <input type="checkbox" id="is_super" style="margin-left: 85px;width: 20px" <?php if($user['is_super'] == 1): ?>checked<?php endif; ?>>
                </div>
                <hr>
            </div>
