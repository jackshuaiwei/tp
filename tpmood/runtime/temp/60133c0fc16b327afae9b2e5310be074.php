<?php /*a:2:{s:70:"D:\phpstudy_pro\WWW\tpmood\application\admin\view\index\userphoto.html";i:1583418132;s:66:"D:\phpstudy_pro\WWW\tpmood\application\admin\view\public\base.html";i:1583480360;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <div style="background-color: #fff;padding: 10px;">
                    ...
                    <table id="table" class="layui-table">
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo url('admin/index/cphoto',['pid'=>$vo['id']]); ?>"><?php echo htmlentities($vo['path']); ?></a></td>
                            <td>
                                <?php foreach($user as $key=>$val): if($vo['user_id'] == $val['id']): ?>
                            ...
                            <td>
                                <div style="width: 80%;margin: 0 auto 0">
                                    <div id="btn">
                                        <a href="<?php echo url('admin/index/cphoto',['pid'=>$vo['id']]); ?>" class="layui-icon">&#xe642;</a>
                                    </div>
