<?php /*a:2:{s:68:"D:\phpstudy_pro\WWW\tpmood\application\admin\view\index\adusers.html";i:1583418541;s:66:"D:\phpstudy_pro\WWW\tpmood\application\admin\view\public\base.html";i:1583480360;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        $('#select').click(function () {
            layui.use('table', function(){
                ...
                if(!username){
                    ...
                    table.render({
                        elem: '#stable'
                        ,url: "sadusers/"+username//数据接口
                        ,page: true //开启分页
                        ,cols: [[ //表头
                            {field: 'id', title: 'ID',  fixed: 'left'}
                            ,{field: 'username', title: '用户名'}
                            ,{field: 'password', title: '密码'}
                            ,{field: 'is_super', title: '超级管理员'}
                        ]]
                    });
                    $('#table').hide();
                    $('#table2').hide();
                ...
                table.on('row(test)', function(obj){
                    var id = obj.data.id;
                    window.location.href = "cadusers/" + id;
                });
...
<div class="con_right">
    <div class="nbar">
        <span class="layui-icon layui-icon-home" style="font-size: 13px;display: inline-block;width: 180px;text-indent: 10px;color: #fff;"><a href="" style="color: #fff;"> 我的主页 / 管理员管理</a></span>
    </div>
    <div>
        <div class="set">
            <div style="background-color: #fff;padding: 10px;">
                <div id="add">
                        <span>
                            <a href="<?php echo url('admin/index/aadusers'); ?>" class="layui-icon">&#xe608;添加</a>
                        </span>
                    <span><a href="<?php echo url('admin/index/adusers'); ?>">全部</a></span>
                ...
                <table id="table" class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo url('admin/index/cadusers',['uid'=>$vo['id']]); ?>"><?php echo htmlentities($vo['username']); ?></a></td>
                        <td><?php if($vo['is_super'] == 1): ?>是 <?php else: ?>否<?php endif; ?></td>
                        <td>
                            <div style="width: 80%;margin: 0 auto 0">
                                <div id="btn">
                                    <a href="<?php echo url('admin/index/cadusers',['uid'=>$vo['id']]); ?>" class="layui-icon">&#xe642;</a>
                                </div>
