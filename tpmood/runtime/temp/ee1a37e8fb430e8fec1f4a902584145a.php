<?php /*a:2:{s:66:"D:\phpstudy_pro\WWW\tpmood\application\admin\view\index\awish.html";i:1583420603;s:66:"D:\phpstudy_pro\WWW\tpmood\application\admin\view\public\base.html";i:1583412358;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <script>
        $(function(){
            ...
            $('#save').click(function () {
                ...
                $.ajax({
                    url:"<?php echo url('admin/index/awish'); ?>",
                    type:'post',
