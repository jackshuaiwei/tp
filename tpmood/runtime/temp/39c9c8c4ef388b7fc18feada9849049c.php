<?php /*a:2:{s:69:"D:\phpstudy_pro\WWW\tpmood\application\admin\view\index\wishlist.html";i:1583479560;s:66:"D:\phpstudy_pro\WWW\tpmood\application\admin\view\public\base.html";i:1583480360;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="con">
    ...
    <div class="con_right">
        <div class="nbar">
            <span class="layui-icon layui-icon-home" style="font-size: 13px;display: inline-block;width: 180px;text-indent: 10px;color: #fff;"><a href="" style="color: #fff;"> 我的主页 / 愿望管理</a></span>
        </div>
        <div>
            ...
            <div class="set">
                <div style="background-color: #fff;padding: 10px;">
                    <div id="add">
                        <span><a href="<?php echo url('admin/index/awish'); ?>" class="layui-icon">&#xe608;添加</a></span>
                    ...
                    <table id="table" class="layui-table">
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo url('admin/index/cwish',['wid'=>$vo['id']]); ?>"><?php echo htmlentities($vo['title']); ?></a></td>
                            <td id="wish_content"><?php echo htmlentities($vo['content']); ?></td>
                            <td>
                                <?php foreach($user as $val): if($val['id']==$vo['user_id']): ?>
                                        <?php echo htmlentities($val['username']); ?>
                                    <?php endif; ?>
                                <?php endforeach; ?>
                            </td>
                            <td>
                                <div style="width: 100px;margin: 0 auto 0">
                                    <div id="btn">
                                        <a href="<?php echo url('admin/index/cwish',['wid'=>$vo['id']]); ?>" class="layui-icon">&#xe642;</a>
                                    </div>
                                    <div id="btn" class="delete">
                                        <a href="javascript:;" wid="<?php echo htmlentities($vo['id']); ?>" class="layui-icon">&#xe640;</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
